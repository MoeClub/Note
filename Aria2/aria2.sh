...
# MOD "src/OptionHandlerFactory.cc" "PREF_ALLOW_OVERWRITE" "1" 'A2_V_FALSE' 'A2_V_TRUE'
# MOD "src/OptionHandlerFactory.cc" "PREF_AUTO_FILE_RENAMING" "0" 'A2_V_FALSE' 'A2_V_TRUE'
